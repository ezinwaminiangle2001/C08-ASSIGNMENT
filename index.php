                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    <a href="./updateform.php" data-id='<?php echo $row['id'] ?>' class="btn btn-success btn-flat">
                                    Update
                                    </a>
                            </div>
                            </td>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="#">
                                ...
                                <!-- <br> -->
                                <button type="submit" class="btn btn-success" name="Submit_teachers_info">Submit</button>
